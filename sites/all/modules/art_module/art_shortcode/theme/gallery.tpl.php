<?php if($filter == 'yes'):?>
<?php $html_id = drupal_html_id('art_gallery');?>
...
<?php endif;?>
<div class="art-gallery"><div style="margin:5px;"><?php print $content;?></div></div>
</div>
<script type="text/javascript">
	jQuery(document).ready(function($){
		var itemwidth = Math.floor(100/<?php print $cols;?>)+'%';
		$('#<?php print $html_id;?> .art-gallery-item').width(itemwidth);
		var $gallery = $('#<?php print $html_id;?> .art-gallery');
		$gallery.isotope({
			// options
