...
<div class="single-post blog-list">
    ...
    <div class="post-meta">
        ...
        <span><a rel="bookmark" title="Permalink to Interview: <?php echo $title; ?>" href="<?php echo $node_url; ?>"><i class="icon-clock"></i> <?php print format_date($node->created, 'custom', 'M d, Y'); ?></a></span>
    </div><!-- end post-meta -->
